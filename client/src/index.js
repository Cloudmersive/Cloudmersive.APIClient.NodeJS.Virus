...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AdditionalAdvancedScanInformation', 'model/CloudStorageAdvancedVirusScanResult', 'model/CloudStorageVirusFound', 'model/CloudStorageVirusScanResult', 'model/ScanCloudStorageBatchJobCreateResult', 'model/ScanCloudStorageJobStatusResult', 'model/VirusFound', 'model/VirusScanAdvancedResult', 'model/VirusScanResult', 'model/WebsiteScanRequest', 'model/WebsiteScanResult', 'api/ScanApi', 'api/ScanCloudStorageApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/AdditionalAdvancedScanInformation'), require('./model/CloudStorageAdvancedVirusScanResult'), require('./model/CloudStorageVirusFound'), require('./model/CloudStorageVirusScanResult'), require('./model/ScanCloudStorageBatchJobCreateResult'), require('./model/ScanCloudStorageJobStatusResult'), require('./model/VirusFound'), require('./model/VirusScanAdvancedResult'), require('./model/VirusScanResult'), require('./model/WebsiteScanRequest'), require('./model/WebsiteScanResult'), require('./api/ScanApi'), require('./api/ScanCloudStorageApi'));
  }
}(function(ApiClient, AdditionalAdvancedScanInformation, CloudStorageAdvancedVirusScanResult, CloudStorageVirusFound, CloudStorageVirusScanResult, ScanCloudStorageBatchJobCreateResult, ScanCloudStorageJobStatusResult, VirusFound, VirusScanAdvancedResult, VirusScanResult, WebsiteScanRequest, WebsiteScanResult, ScanApi, ScanCloudStorageApi) {
  'use strict';
  ...
  var exports = {
    ...
    /**
     * The ScanCloudStorageBatchJobCreateResult model constructor.
     * @property {module:model/ScanCloudStorageBatchJobCreateResult}
     */
    ScanCloudStorageBatchJobCreateResult: ScanCloudStorageBatchJobCreateResult,
    /**
     * The ScanCloudStorageJobStatusResult model constructor.
     * @property {module:model/ScanCloudStorageJobStatusResult}
     */
    ScanCloudStorageJobStatusResult: ScanCloudStorageJobStatusResult,
    /**
