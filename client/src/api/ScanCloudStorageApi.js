...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CloudStorageAdvancedVirusScanResult', 'model/CloudStorageVirusScanResult', 'model/ScanCloudStorageBatchJobCreateResult', 'model/ScanCloudStorageJobStatusResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CloudStorageAdvancedVirusScanResult'), require('../model/CloudStorageVirusScanResult'), require('../model/ScanCloudStorageBatchJobCreateResult'), require('../model/ScanCloudStorageJobStatusResult'));
  } else {
    // Browser globals (root is window)
    if (!root.CloudmersiveVirusApiClient) {
      root.CloudmersiveVirusApiClient = {};
    }
    root.CloudmersiveVirusApiClient.ScanCloudStorageApi = factory(root.CloudmersiveVirusApiClient.ApiClient, root.CloudmersiveVirusApiClient.CloudStorageAdvancedVirusScanResult, root.CloudmersiveVirusApiClient.CloudStorageVirusScanResult, root.CloudmersiveVirusApiClient.ScanCloudStorageBatchJobCreateResult, root.CloudmersiveVirusApiClient.ScanCloudStorageJobStatusResult);
  }
}(this, function(ApiClient, CloudStorageAdvancedVirusScanResult, CloudStorageVirusScanResult, ScanCloudStorageBatchJobCreateResult, ScanCloudStorageJobStatusResult) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the scanCloudStorageGetAsyncJobStatus operation.
     * @callback module:api/ScanCloudStorageApi~scanCloudStorageGetAsyncJobStatusCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ScanCloudStorageJobStatusResult} data The data returned by the service call.
    ...
    this.scanCloudStorageGetAsyncJobStatus = function(asyncJobID, callback) {
      ...
      var returnType = ScanCloudStorageJobStatusResult;

      return this.apiClient.callApi(
        '/virus/scan/cloud-storage/batch-job/status', 'GET',
     ...
     * @param {Boolean} opts.allowUnwantedAction Set to false to block unwanted or undesired actions, which can contain execute or open links or content when the file is viewed.  Default is false (recommended).  If set to true, unwanted actions will be allowed.
     * @param {String} opts.options Comma separated set of configuration operations.  Include permitJavascriptAndHtmlInPDFs to allow JavaScript and HTML in PDF files.  Include blockOfficeXmlOleEmbeddedFile to block embedded OLE files in Office Documents using the modern file format.  Default is no options.
    ...
    /**
     * Callback function to receive the result of the scanCloudStorageScanAzureBlobAdvancedBatchJob operation.
     * @callback module:api/ScanCloudStorageApi~scanCloudStorageScanAzureBlobAdvancedBatchJobCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ScanCloudStorageBatchJobCreateResult} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.options Comma separated set of configuration operations.  Include permitJavascriptAndHtmlInPDFs to allow JavaScript and HTML in PDF files.  Include blockOfficeXmlOleEmbeddedFile to block embedded OLE files in Office Documents using the modern file format.  Include scanMultipartFile to scan multi-part files such as split zip files.  Default is no options.
     * @param {String} opts.restrictFileTypes Specify a restricted set of file formats to allow as clean as a comma-separated list of file formats, such as .pdf,.docx,.png would allow only PDF, PNG and Word document files.  All files must pass content verification against this list of file formats, if they do not, then the result will be returned as CleanResult=false.  Set restrictFileTypes parameter to null or empty string to disable; default is disabled.
     * @param {module:api/ScanCloudStorageApi~scanCloudStorageScanAzureBlobAdvancedBatchJobCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ScanCloudStorageBatchJobCreateResult}
     */
    this.scanCloudStorageScanAzureBlobAdvancedBatchJob = function(connectionString, containerName, blobPath, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'connectionString' is set
      if (connectionString === undefined || connectionString === null) {
        throw new Error("Missing the required parameter 'connectionString' when calling scanCloudStorageScanAzureBlobAdvancedBatchJob");
      }

      // verify the required parameter 'containerName' is set
      if (containerName === undefined || containerName === null) {
        throw new Error("Missing the required parameter 'containerName' when calling scanCloudStorageScanAzureBlobAdvancedBatchJob");
      }

      // verify the required parameter 'blobPath' is set
      if (blobPath === undefined || blobPath === null) {
        throw new Error("Missing the required parameter 'blobPath' when calling scanCloudStorageScanAzureBlobAdvancedBatchJob");
      }
      ...
      var contentTypes = ['multipart/form-data'];
      var accepts = ['application/json', 'text/json', 'application/xml', 'text/xml'];
      var returnType = ScanCloudStorageBatchJobCreateResult;

      return this.apiClient.callApi(
        '/virus/scan/cloud-storage/azure-blob/single/advanced/batch-job', 'POST',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
