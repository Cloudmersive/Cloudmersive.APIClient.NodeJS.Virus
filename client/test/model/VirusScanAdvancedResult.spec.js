  ...
  describe('(package)', function() {
    describe('VirusScanAdvancedResult', function() {
      ...
      it('should create an instance of VirusScanAdvancedResult', function() {
        // TODO: update the code to test VirusScanAdvancedResult
      ...
      it('should have the property ContainsUnwantedAction (base name: "ContainsUnwantedAction")', function() {
        // TODO: update the code to test the property ContainsUnwantedAction
        expect(instance).to.have.property('ContainsUnwantedAction');
        // expect(instance.ContainsUnwantedAction).to.be(expectedValueLiteral);
      });
